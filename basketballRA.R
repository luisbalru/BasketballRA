...
# 2 -> (159, 185), (175,195),(186,200)
alt_bajo = ifelse(data$heightInteger >= 159 & data$heightInteger <= 185, "Si","No")
alt_ma = ifelse(data$heightInteger >= 175 & data$heightInteger <= 195, "Si", "No")
alt_a = ifelse(data$heightInteger >= 186 & data$heightInteger<=200, "Si", "No")
...
# 2 --> (1,5) (3,7) (4.6,10) (7,14)
asist_ba = ifelse(data$assists>=1 & data$assists<=5, "Si","No")
asist_am = ifelse(data$assists>=3 & data$assists<=7, "Si","No")
asist_aa = ifelse(data$assists>=4.6 & data$assists<=10, "Si","No")
asist_pn = ifelse(data$assists>=7 & data$assists<=14, "Si","No")
# Edad: Rookie(20,25), Sophomore(23,26), Experimentado(24,32), Veterano(28,41)
# 2 --> (20,25), (22,27) (24,35) (29,41)
edad_r = ifelse(data$ageInteger>=20 & data$ageInteger<=25,"Si", "No")
edad_s = ifelse(data$ageInteger>=22 & data$ageInteger<=27,"Si", "No")
edad_e = ifelse(data$ageInteger>=24 & data$ageInteger<=35,"Si", "No")
edad_v = ifelse(data$ageInteger>=29 & data$ageInteger<=41,"Si", "No")
# Tiempo: Suplente(10,19), Sexto hombre(15,27), titular(25,35), estrella(29,41)
...
temp_t = ifelse(data$time_playedReal>=25 & data$time_playedReal<=35, "Si", "No")
temp_e = ifelse(data$time_playedReal>=29 & data$time_playedReal<=41, "Si", "No")
# Puntos: Baja anotación(6,10), Anotación media(8,17), Protagonista(15,26), Amo del Parqué(22.34)
# 2 --> (6,13) (8,17) (13,28) (22,34)
punt_ba = ifelse(data$points >=6 & data$points<=13,"Si", "No")
punt_am = ifelse(data$points >=8 & data$points<=17,"Si", "No")
punt_p = ifelse(data$points >=13 & data$points<=28,"Si", "No")
...
write(reglas.ta,"reglas-ta2.csv",sep=",")
